@include('layout.header')
	...
	<div class="container login">
		<div class="row">
				...
				<div class="limiter">
					<div class="container-login100 ">
						<div class="wrap-login100">
							<form  class="login100-form validate-form m-t-65 p-l-106 p-r-57" method="" action="">
			...
			<div class="col-sm">
				<div class="limiter two">
					<div class="container-login100 container-two">
						<div class="wrap-login100 login-two">

							<form class="login100-form validate-form p-t-55 p-b-55 p-l-55 p-r-55"  method="" action="">
								<span class="login100-form-title title-two">
									Participer à votre <br> assemblée générale.
								</span>
